...
RESOURCES += src/qt/exio.qrc src/qt/exio_locale.qrc

TRANSLATIONS += src/qt/locale/exio_bg.ts \
                src/qt/locale/exio_de.ts \
                src/qt/locale/exio_en.ts \
                src/qt/locale/exio_es.ts \
                src/qt/locale/exio_fi.ts \
                src/qt/locale/exio_fr.ts \
                src/qt/locale/exio_it.ts \
                src/qt/locale/exio_ja.ts \
                src/qt/locale/exio_pl.ts \
                src/qt/locale/exio_pt.ts \
                src/qt/locale/exio_ru.ts \
                src/qt/locale/exio_sk.ts \
                src/qt/locale/exio_sv.ts \
                src/qt/locale/exio_vi.ts \
                src/qt/locale/exio_zh_CN.ts \
                src/qt/locale/exio_zh_TW.ts
