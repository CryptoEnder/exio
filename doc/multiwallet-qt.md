...
In order to support loading of multiple wallets in exio-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is exio.cpp.
...
Changes to exio.cpp
----------------------
exio.cpp is the entry point into exio-qt, and as such, will require some minor modifications to provide hooks for
