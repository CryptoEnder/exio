...
This mechanism has been integrated into Bitcore-Node-EXO which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/EXO-Project/insight-api-exio#web-socket-api](https://github.com/EXO-Project/insight-api-exio#web-socket-api) 
* API: [https://github.com/EXO-Project/insight-api-exio#swifttx-transactions](https://github.com/EXO-Project/insight-api-exio#swifttx-transactions) 
...
By default, the Exio Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Exio Core daemon:
