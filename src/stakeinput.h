...
#ifndef EXO_STAKEINPUT_H
#define EXO_STAKEINPUT_H
...
public:
    ...
    virtual bool IszEXO() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zEXOStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zexo, which is a zcspend that has successfully staked
...
public:
    ...
    bool IszEXO() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IszEXO() override { return false; }
};


#endif //EXO_STAKEINPUT_H
