...
extern UniValue setzexoseed(const UniValue& params, bool fHelp);
extern UniValue getzexoseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzexo(const UniValue& params, bool fHelp);
extern UniValue dzexostate(const UniValue& params, bool fHelp);
