...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EXO features */
        {"exio", "masternode", &masternode, true, true, false},
        {"exio", "listmasternodes", &listmasternodes, true, true, false},
        {"exio", "getmasternodecount", &getmasternodecount, true, true, false},
        {"exio", "masternodeconnect", &masternodeconnect, true, true, false},
        {"exio", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"exio", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"exio", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"exio", "masternodecurrent", &masternodecurrent, true, true, false},
        {"exio", "masternodedebug", &masternodedebug, true, true, false},
        {"exio", "startmasternode", &startmasternode, true, true, false},
        {"exio", "createmasternodekey", &createmasternodekey, true, true, false},
        {"exio", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"exio", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"exio", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"exio", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"exio", "getmasternodescores", &getmasternodescores, true, true, false},
        {"exio", "mnbudget", &mnbudget, true, true, false},
        {"exio", "preparebudget", &preparebudget, true, true, false},
        {"exio", "submitbudget", &submitbudget, true, true, false},
        {"exio", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"exio", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"exio", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"exio", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"exio", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"exio", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"exio", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"exio", "checkbudgets", &checkbudgets, true, true, false},
        {"exio", "mnsync", &mnsync, true, true, false},
        {"exio", "spork", &spork, true, true, false},
        {"exio", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzexoseed", &getzexoseed, false, false, true},
        {"zerocoin", "setzexoseed", &setzexoseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzexo", &searchdzexo, false, false, true},
        {"zerocoin", "dzexostate", &dzexostate, false, false, true}
...
{
    return "> exio-cli " + methodname + " " + args + "\n";
}
