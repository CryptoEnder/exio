...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::EXO);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeBitCoinOneAmount"))
        SoftSetArg("-anonymizeexioamount", settings.value("nAnonymizeBitCoinOneAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in exio.cpp during shotdown to also remove the window positions
