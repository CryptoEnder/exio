                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzEXOPathCustom = GetArg("-zexobackuppath", "");
    ...
    if(!strzEXOPathCustom.empty()) {
        ui->wallet_customzexobackuppath->setText(QString::fromStdString(strzEXOPathCustom));
        ui->wallet_customzexobackuppath_label->setVisible(true);
        ui->wallet_customzexobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzEXOPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the EXO RPC console.") + "<br>" +
