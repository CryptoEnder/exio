Contributing to Exio Core
============================

The Exio Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Exio Core project, and is not to be
confused with overall EXO Network Protocol consensus changes.

Whether a pull request is merged into Exio Core rests with the project merge
...
Patches that change EXO consensus rules are considerably more involved than
...
Where a patch set proposes to change the EXO consensus, it must have been
...
The project leader is the release manager for each Exio Core release.
